...
QT_MOC_LITERAL(3, 16, 22), // "on_button_quit_clicked"
QT_MOC_LITERAL(4, 39, 26) // "on_button_concrete_clicked"

    },
    "change\0success\0\0on_button_quit_clicked\0"
...
void change::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_button_concrete_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&change::success)) {
                *result = 0;
                return;
            }
        }
